...
ChainTypes.operations = {
    ...
    data_market_category_create:47,
    data_market_category_update:48,
    free_data_product_create:49,
    free_data_product_update:50,
    league_data_product_create:51,
    league_data_product_update:52,
    league_create:53,
    league_update:54,
    search_data_form_create: 55,
    search_data_form_update: 56,
    personal_auth_create: 57
};
