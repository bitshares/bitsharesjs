...
ChainTypes.operations = {
    ...
    data_market_category_create_operation:47,
    data_market_category_update_operation:48,
    free_data_product_create_operation:49,
    free_data_product_update_operation:50,
    league_data_product_create_operation:51,
    league_data_product_update_operation:52,
    league_create_operation:53,
    league_update_operation:54,
    search_data_form_create_operation: 55,
    search_data_form_update_operation: 56,
    personal_auth_create_operation: 57
};
