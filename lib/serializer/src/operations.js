...
export const account_upgrade_merchant = new Serializer(
    "account_upgrade_merchant",
    {
        fee: asset,
        account_to_upgrade: protocol_id_type("account"),
        upgrade_to_merchant_member: bool,
        auth_referrer: protocol_id_type("account"),
        extensions: set(future_extensions)
    }
);
...
export const account_upgrade_datasource = new Serializer(
    "account_upgrade_datasource",
    {
        fee: asset,
        account_to_upgrade: protocol_id_type("account"),
        upgrade_to_datasource_member: bool,
        auth_referrer: protocol_id_type("account"),
        extensions: set(future_extensions)
    }
);
...
export const data_market_category_create_operation = new Serializer(
