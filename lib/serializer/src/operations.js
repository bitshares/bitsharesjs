...
export const personal_auth_create = new Serializer('personal_auth_create',{})
...
export const create_date_transaction = new Serializer(
    "create_date_transaction",
    {
        ...
        version: string,
        params: string,
        prod_id:protocol_id_type('date_transaction'),
        requester: protocol_id_type("account")
    }
);

export const update_data_transaction = new Serializer('update_data_transaction',{
    fee: asset,
    request_id: string,
    new_status: uint8,
